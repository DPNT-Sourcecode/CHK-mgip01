...
enum item {
    ...
    C("C", 20, false, false, false), D("D", 15, false, false, false), E("E", 40, false, true, false), // 2E get one B
    // free
...
enum offer {
    ...
    // numItems, price
    A1(5, 200), A2(3, 130), B(2, 45), H1(10, 80), H2(5, 45), K(2, 120), P(5, 200), Q(3, 80), V1(3, 130), V2(2, 90),
...
enum specialOffer {
    ...
    E(2, item.B), F(2, item.F), N(3, item.M), R(3, item.Q), U(3, item.U);
